...
const SignIn: ReactFC = () => {
  ...
  return (
    <>
      ...
      <div className="bg-white flex flex-column items-center">
          ...
          <div className="flex flex-wrap items-center w-screen">
            <div className="hidden w-full xl:block xl:w-1/2">
              <div className="py-17.5 px-26 text-center">
                <Link className="mb-0.5 inline-block" href="/">
            ...
            <div className="p-5  xl:mx-15 bsm:p-12.5 bmd:p-17.5 rounded-md bg-gray border border-stroke dark:border-strokedark dark:bg-boxdark">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-5">
                    <button
                      disabled={processing}
                      className="w-full cursor-pointer rounded-lg border border-primarycolor bg-primarycolor p-2.5 text-white transition hover:bg-opacity-90"
                    >
                      Sign In
                    </button>
                  </div>
...
SignIn.layout = ((page: any) => <Main children={page} />)
