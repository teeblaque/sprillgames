...
// const ResetPassPropTypes = {
//   token: PropTypes.string,
//   email: PropTypes.string,
//   // email: PropTypes.string.isRequired,
// };

// type ResetPassTypes = InferProps<typeof ResetPassPropTypes>;

// const ResetPass: ReactFC = ({token, email}: ResetPassTypes) => {
const ResetPass: ReactFC = () => {
  ...
  console.log("token")
  console.log(flash.token)
  console.log("email")
  console.log(flash.email)
        ...
        <div className="rounded-sm bg-whitje">
          <div className="flex flex-wrap items-center w-screen">
            <div className="hidden w-fulll md:block md:w-1/2">
              <div className="py-17.5 px-26 text-left">
                <Link className="mb-1.5 md:px-20 inline-block" href="/">
            ...
            { flash.error &&  <AlertMessage type={AlertMessageType.error} message={flash.error} />}
            { flash.message &&  <AlertMessage type={AlertMessageType.success} message={flash.message} />}
            </div>
                    ...
                    <div className="mb-6">
                      ...
                      <div className="relative">
                        <input
                          ...
                          className={"w-full rounded-lg border border-stroke bg-white p-2.5 text-sm pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary " + ((values.confPasswordError != "" || data.confPassword != data.password) ? '!ring-red' : '')}
                        />
...
// ResetPass.propTypes = ResetPassPropTypes;
ResetPass.layout = ((page: any) => <Main children={page} />)
